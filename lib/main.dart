/// FolioPod — bank account monitoring with Solid Pod storage.
///
...
import 'package:foliopod/app_scaffold.dart';
...
void main() async {
  ...
  runApp(
    ChangeNotifierProvider(
      ...
      child: const FolioPodApp(),
    ),
  );
}

class FolioPodApp extends StatefulWidget {
  const FolioPodApp({super.key});

  @override
  State<FolioPodApp> createState() => _FolioPodAppState();
}

class _FolioPodAppState extends State<FolioPodApp> {
  @override
  void initState() {
    super.initState();
    _initTheme();
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SolidLogin(
        ...
        link: 'https://github.com/gjwgit/foliopod',
        clientId: 'https://gjwgit.github.io/foliopod/client-profile.jsonld',
        redirectUris: kIsWeb
